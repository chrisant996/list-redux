...
static const FlagUsageInfo c_usage_info[] =
{
    ...
    { FLAGS,    "-f text",                  "Find 'text' in the file arguments.\n" },
    { FLAGS,    "-i",                       "Ignore case with -f and -r (default is exact case).\n" },
    { FLAGS,    "-r regex",                 "Find regular expression 'regex' in the file arguments.\n" },
    ...
    { FLAGS,    "--exact-case",             "Find exact case with -f and -r (default is exact case).\n" },
    { FLAGS,    "--find text",              "Find 'text' in the file arguments.\n" },
    { FLAGS,    "--hex",                    "Display files in hex view.\n" },
    { FLAGS,    "--hex-edit",               "Activate hex editing mode for single file.\n" },
    { FLAGS,    "--ignore-case",            "Ignore case with -f and -r (default is exact case).\n" },
    ...
    { FLAGS,    "--regex regex",            "Find regular expression 'regex' in the file arguments.\n" },
